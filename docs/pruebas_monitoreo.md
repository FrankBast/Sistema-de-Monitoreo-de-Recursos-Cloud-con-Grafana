...
| P-003  | RAM Alta               | 1) Ejecutar `stress --vm 1 --vm-bytes 1600M --timeout 180s` <br> 2) Observar panel RAM | RAM > 85% (>1.7GB) y alerta CRITICAL | RAM 1.82GB (91%), SWAP 5%, alerta WARNING activada | screenshots/P-003_ram.png | Ajuste severidad a CRITICAL >90% (branch: fix/ram-threshold) | v1.2 |
