...
|-----|-----------|------------------------|--------------------|----------------|-------------------|-----------------|------------------|
| P-001 | Normal (todo OK) | 1) Verificar dashboard X 2) Revisar panel Y | KPI dentro de rango | KPI dentro de rango | Screenshots/Image 2026-02-11 at 3.47.37 PM.jpeg | Ninguno | v1 |
