...
|-----|-----------|------------------------|--------------------|----------------|-------------------|-----------------|------------------|
| P-001 | Normal (todo OK) | 1) Verificar panel Quick CPU/Mem/Disk 2) Revisar gráficos básicos| KPI dentro de rango | CPU Busy 3.8%, RAM Used 7.7%, Disco 25.7%, sin alertas | Screenshots/Image 2026-02-11 at 3.47.37 PM.jpeg | Ninguno | v1 |
